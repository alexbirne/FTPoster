...
\begin{pgfonlayer}{foreground}
  ...
  \node[tagger_label,align=left] (SSpip_label) [right=of SSpip] {SS pion (BDT)\\SS proton\\ SS kaon (nnet)(for $\mathsfit{ B_s^{0}}$)};
  ...
  \node[tagger_label,align=left] (OScharm_label)  [above=of OS_TV] {OS charm};
