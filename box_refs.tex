...
\begin{minipage}{0.474\boxwidth}
\begin{compactitem}
{\tiny\item[{[6]}] LHCb Collaboration, R. Aaij et. al., {\it Measurement of the time-dependent \CP asymmetry in \BdToJPsiKS decays, } Phys.Lett. B721 (2013) 24-31}
\end{compactitem}
\begin{compactitem}
{\tiny\item[{[7]}] LHCb Collaboration, R. Aaij et. al., {\it Measurement of \CP violation in \BdToJPsiKS decays, } Phys.Rev.Lett. 115 (2015) 031601}
\end{compactitem}
\begin{compactitem}
