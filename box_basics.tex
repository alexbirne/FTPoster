...
Measurements of flavour oscillations and time-dependent \CP asymmetries in neutral $B$ meson systems require knowledge of the $b$ quark production flavour. This identification is performed by the Flavour Tagging. [1,2]\\[0.9em]
...
use charged particles created in the fragmentation process of the b quark of the signal \B meson
\vspace{-0.59em}
\begin{itemize}
