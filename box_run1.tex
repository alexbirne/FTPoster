...
\textbf{Usage in analyses}\\[-0.55em]
\begin{itemize}
...
%\begin{flushleft}
\hspace{-1.5em}
\includegraphics[width=0.494\boxwidth]{figures/Bs2JpsiKK2.pdf}
%\end{flushleft}
\vspace{-1.5em}
...
\vspace{-2.4em}
	...
	\setlength\itemsep{0.01em}
	\setlength{\itemindent}{-.11in}
	\item[${\color{tu_gruen}-}$] \Bs events: $\varepsilon_{\text{eff}, \Bs}=\SI{4.00}{\%}$, $\varepsilon_{\text{eff}, \Bz}=\SI{2.62}{\%}$ [8]
	...
	\vspace{-0.35em}
		...
		%\setlength{\itemindent}{.05in}
		\item[${\color{tu_gruen}\Rightarrow}$] kaons have opposite charge: invert tag
		\end{itemize}
	\end{itemize}
